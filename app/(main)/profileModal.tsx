    ...
    return (
        <ScreenWrapper isModal={true}>
            <View style={styles.container}>
                <Header title='Update Profile' leftIcon={Platform.OS == 'android' && <BackButton color={colors.black} />} style={{ marginVertical: spacingY._15 }} />
                ...
                <ScrollView contentContainerStyle={styles.form}>
                    ...
                    <View style={{ gap: spacingY._20 }}>
                        <View style={styles.inputContainer}>
                            ...
                            <Input value={userData.email} containerStyle={{ borderColor: colors.neutral350, paddingLeft: spacingX._20, backgroundColor: colors.neutral300 }} />
                        </View>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <Input value={userData.name} containerStyle={{
                                borderColor: colors.neutral350, paddingLeft: spacingX._20,
                                // backgroundColor: colors.neutral300 
                            }}
                                editable onChangeText={(value) => setUserData({ ...userData, name: value })} />
                        </View>
                    </View>
                </ScrollView>
            </View>
            <View style={styles.footer}>
                {!loading && <Button style={{ backgroundColor: colors.rose, height: verticalScale(56), width: verticalScale(56) }} onPress={showLogoutAlert}>
